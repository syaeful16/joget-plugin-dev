...
<#if !(request.getAttribute("com.syan.dev.lib.FormGridCustom")??) >
    <script type="text/javascript" src="${request.contextPath}/plugin/com.syan.dev.lib.FormGridCustom/js/jquery.enterpriseformgridcustom.js"></script>
    <script type="text/javascript" src="${request.contextPath}/plugin/com.syan.dev.lib.FormGridCustom/js/jquery.gridPaging.js"></script>
    <script type="text/javascript" src="${request.contextPath}/plugin/com.syan.dev.lib.FormGridCustom/js/test.js"></script>
    <script>
